...
<template>
    <div>
        <div className="relative"> 
            <Header></Header>  
            <div className="w-full mb-10 -z-50 h-[550px] border-b mx-auto flex flex-row justify-around items-center">
                <div className="flex flex-col ">
                    <span className="text-5xl font-semibold text-black">Lorem ipsum dolor sit amet,</span> 
                    <span className="text-5xl font-semibold text-black flex-shrink-0">consectetur adipisicing elit.</span>
                    <span className="text-lg font-semibold text-black flex-shrink-0 mt-5">Get incredible deals, up to 12% off</span>
                ...
                <div>
                    <div class="hover:rotate-180 transition-transform duration-500 ease-out">
                        <img class="w-96" src="https://www.apple.com/v/iphone-17/d/images/meta/iphone-17_overview__d4o74q28yjma_og.png?202512230653" />
                    </div>
                </div>
            </div>

            <div className="container__own rounded-md mt-16">
                <div class="flex justify-between h-28 gap-4">
                    <div class="flex-1 flex
                        justify-start
                        items-center
                        gap-2 rounded-md  px-3 shadow-md">
                        <img class="w-24" src="https://p1-ofp.static.pub/MOTO/edge70/edge-70-PANTONE-Gadget-Grey-UK-bundle-product.png" />
            ...
            <div class="bg-gray-50 mt-16">
                <div class="container__own flex justify-center pt-5 pb-5 flex-wrap mt-18">
                <!-- <p class="text-2xl font-semibold">Nossos Produtos</p> -->
                    <div class="w-full">
                        <ul class="flex justify-center mb:gap-3 mt-7 gap-3 text-[16px] font-medium flex-wrap">
                            <li class="md:mt-0 border px-4 py-2 rounded-full shadow-sm transition-all ease-out 
                            first:bg-black first:text-white
                            hover:bg-black hover:text-white" v-for="cat in category">
                ...
                <div class="container__own relative mx-auto
                grid
                grid-cols-5
                gap-2
                mt-3">
            ...
            <div class="bg-gray-50 py-10">
                <div className="container__own rounded-md   bg-gray-50">
                    <div class="
                    flex 
                    justify-between 
                    h-24">
            ...
            <div class="h-96 flex flex-col items-center text-white justify-center font-light text-lg bg-blue-700">
